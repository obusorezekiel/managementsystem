...
class ProjectsController extends Controller
{
    ...
    public function update(Request $request, Project $project)
    {
        ...
        if($projectUpdate){
            return redirect()->route('projects.show',['project'=>$project->id])->with('success', 'project updated successful');
        }
    ...
    public function destroy(Project $project)
    {
        ...
        if($findproject->delete()){
            ...
            return redirect()->route('1projects.index')->with('success', 'project deleted successfully');
        }
